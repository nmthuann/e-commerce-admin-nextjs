...
const UPDATE_PRRODUCT_URL=`${process.env.NEXT_PUBLIC_API_URL}/product/update`
const UPDATE_IMAGES_URL = `${process.env.NEXT_PUBLIC_API_URL}/image/update-images` //:product_id
