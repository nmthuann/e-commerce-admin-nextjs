...
const CREATE_PRRODUCT_URL=`${process.env.NEXT_PUBLIC_VERCEL_URL}/product/create`
const CREATE_IMAGES_URL = `${process.env.NEXT_PUBLIC_VERCEL_URL}/image/insert-images` //:product_id
